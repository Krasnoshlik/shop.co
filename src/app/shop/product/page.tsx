            ...
            {tabsChoose === "Product Details" && (
              <div className=" flex flex-col gap-3">
                ...
                <ul>
                  ...
                  <li>
                    <span className=" font-bold">Buttons and Pockets:</span>
              ...
              <div className=" flex flex-col gap-5">
                ...
                <ul className=" flex flex-col gap-4">
                  <li>
                    ...
                    <br />
                    We offer a wide range of clothing including tops, bottoms,
                    dresses, outerwear, activewear, and accessories for men,
                    women, and children.
                  </li>
                  <li>
                    <span className=" font-bold">
                    ...
                    <br />
                    Currently, we are an online-only store. We do not have any
                  ...
                  <li>
                    ...
                    support@yourshop.com or call us at 1-800-123-4567 from 9 AM
                    to 5 PM (EST), Monday through Friday.
                  </li>
                </ul>
              </div>
            )}
